//
//  LGF+UITextView.swift
//  LGFSwiftTool
//
//  Created by 来 on 2019/9/25.
...
public extension UITextView {
    ...
    func lgf_AppendLinkString(_ string:String, _ withURLString: String = "") {
        //原来的文本内容
    ...
    // MARK: - 添加链接文本（链接为空时则表示普通文本）
    func lgf_AppendLinkString(_ string:String, _ withURLString:String = "", _ backGroundColor: UIColor) {
        //原来的文本内容
        let attrString:NSMutableAttributedString = NSMutableAttributedString()
        attrString.append(self.attributedText)
        let paragraphStyle = NSMutableParagraphStyle()
